...
class BTreeNode {
    ...
    BTreeNode **C;
public:
    BTreeNode(int tt, bool leaf1); // Konstruktor
...
int main() {
	int a, b,c; 
    int k;
	cout << "Masukan Max Degree : "; cin >>a;
    BTree t(a);
	cout << "Masukan jumlah nilai : "; cin >>c;
	for (int i = 1; i <= c; i++){
	...
	cout << " 	MAX DEGREE = " << a	<< endl;
    t.traverse();
    cout << endl;
    
	cout <<"  Masukan Nilai yang akan dicari : "; cin >> k;
    if (t.search(k) != NULL) 
